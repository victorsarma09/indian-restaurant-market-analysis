...
![Domain](https://img.shields.io/badge/Domain-Restaurant%20Market-red)
...
![Rating Distribution](plots/plot01_rating_distribution.png)

### 02 — Top 10 Cities by Restaurant Count
![Top Cities](plots/plot02_top_cities.png)

### 03 — Top 10 Primary Cuisines
![Top Cuisines](plots/plot03_top_cuisines.png)

### 04 — Rating Category Breakdown
![Rating Categories](plots/plot04_rating_categories.png)

### 05 — Price Band Distribution
![Price Bands](plots/plot05_price_bands.png)

### 06 — Delivery Time Distribution
![Delivery Time](plots/plot06_delivery_time.png)

### 07 — Average Rating by City
![Rating by City](plots/plot07_avg_rating_city.png)

### 08 — Safety Compliance Distribution
![Safety](plots/plot08_safety_measures.png)

### 09 — Rating vs Price
![Rating vs Price](plots/plot09_rating_vs_price.png)

### 10 — Delivery Speed Distribution
![Delivery Speed](plots/plot10_delivery_speed.png)

### 11 — Cuisine Diversity by City
![Cuisine Diversity](plots/plot11_cuisine_diversity.png)

### 12 — Price Band vs Average Rating
![Price vs Rating](plots/plot12_price_band_vs_rating.png)
